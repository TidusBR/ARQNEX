 ...
 * @returns 
 */
export default function CardCollection({ imgProps, info, isOpen }) {
    ...
    useEffect(() => {
        fetch(`${config.api}${config.endpoints.account.name.replace('%1', info.author_id)}`)
                ...
                <div className="container h-100 py-4 d-flex flex-column justify-content-between">
                    <div className="row  px-4">
                        <div className="col-12 d-flex flex-row align-items-center justify-content-between mb-3">
                            ...
                            <button style={{border: "2px solid #EEEEEE", background: "white"}} className='p-2 rounded fw-bold'>Curtir
                                <i className='m-0 ms-3'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <g id="ic_like" transform="translate(-1819 124)">
                                            ...
                                            <path id="Path_12" data-name="Path 12" d="M10.719,19,9.455,17.849C4.965,13.777,2,11.092,2,7.8A4.749,4.749,0,0,1,6.8,3a5.221,5.221,0,0,1,3.924,1.822A5.221,5.221,0,0,1,14.643,3a4.749,4.749,0,0,1,4.8,4.8c0,3.3-2.965,5.981-7.455,10.062Z" transform="translate(1820 -123)" fill="#1d252c"/>
                                        </g>
                                    </svg>
                                </i>
                            </button>
                                ...
                                <div className="row justify-content-md-center">
                                    {
                                        info.files.slice(1).map((url, index) => (
                                            <div className="col-md-3" key={index} style={index > 3 ? {display: "none"} : {display: "block"}}>
                                                <a href={`${config.api}/${url}`}>
                                                    <img src={`${config.api}/${url}`} className='card-job' alt="" style={{width: "100%" ,height: "8rem"}} />
                                                </a>
                                            </div>
                                        ))
                                    }
                        ...
                        <div className="row">
                            <div className="col-12 d-flex justify-content-between align-items-center">
                                <div className='d-flex align-itens-center'>
                                    ...
                                    <p style={{color: "#1D252C"}}>350 visualizações</p>
                                </div>
                                <div className='d-flex align-itens-center'>   
                                    <svg className='p-0 m-0 me-3' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <g id="ic_like" transform="translate(-1819 124)">
                                    ...
                                    <p style={{color: "#1D252C"}}>100 curtidas</p>
                                </div>
                                <div className='d-flex align-itens-center'>
                                    <svg className='p-0 m-0 me-3' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    <p style={{color: "#1D252C"}}>05 Setembro, 2023</p>
                                </div>
                            </div>
                        </div>
                    </div>
