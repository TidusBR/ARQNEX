                ...
                <div className="container h-100 py-4 d-flex flex-column justify-content-between">
                    <div className="row">
                        <div className="col-12 d-flex flex-row align-items-center justify-content-between mb-3">
                            ...
                            {
                            session.loggedIn &&
                            <button style={{border: "2px solid #EEEEEE", background: "white", color: isLiked ? "red" : "black", textWrap: "nowrap"}} className='p-2 rounded fw-bold' onClick={likeCollection}>Curtir
                                <i className='m-0 ms-1 ms-sm-3'>
                            ...
                            <div className='col-12'>
                                {
                                    info.softwares.map((software) => (
                                        <span style={{border: "2px solid #EEEEEE", display: "inline-block"}} key={software.id} className='fw-bold p-2 rounded me-3 softwares'>
                                            {
                                            software.iconPath &&
                        ...
                        <div className="row">
                            <div className="col-12 d-flex justify-content-between align-items-center px-0">
                                <div className='d-flex align-itens-center'>
                                    ...
                                    <p style={{color: "#1D252C"}}>{views} <span className='text-data-job'>visualizações</span> </p>
                                </div>
                                <div className='d-flex align-itens-center'>   
                                    <svg className='p-0 m-0 me-3' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <g id="ic_like" transform="translate(-1819 124)">
                                    ...
                                    <p style={{color: "#1D252C"}}>{likes} <span className='text-data-job'>curtidas</span> </p>
                                </div>
                                <div className='d-flex align-itens-center'>
                                    <svg className='p-0 m-0 me-3' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
